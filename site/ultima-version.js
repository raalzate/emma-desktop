/**
 * Enlaza la vitrina a la ÚLTIMA release publicada, sin tocar el HTML en cada
 * versión.
 *
 ...
 */
(() => {
  const REPO = 'raalzate/emma-desktop';
  ...
  function assetPara(assets, sufijos) {
    return assets.find((a) => sufijos.some((s) => a.name.toLowerCase().endsWith(s)));
  }
