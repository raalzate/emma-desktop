  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "flex h-full w-[--sidebar-width] flex-col bg-card border-r",
            className
          )}
          ref={ref}
          {...props}
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[state=expanded]:pl-0 md:peer-data-[state=collapsed]:peer-data-[collapsible=icon]:pl-0",
        className
      )}
      {...props}
    />
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "duration-200 flex h-8 shrink-0 items-center rounded-md px-2 text-sm font-semibold text-foreground outline-none ring-ring transition-[margin,opa] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
